...
<body>
        ...
        <ul class="FAQ__list">
            <li>
                <details>
                    ...
                    <p class="FAQ__answer">
                        하단의 잡스비네이터 또는 <a href="http://hjkang306.dothome.co.kr/php/Notice/inquiryWrite.php">여기</a>를 눌러 문의 사항을 보내주세요.
                    </p>
                </details>
            </li>
            <li>
    ...
    <script>
        ...
        inqueryBtn.addEventListener('click', () => {
            location.href = "http://hjkang306.dothome.co.kr/php/Notice/inquiryWrite.php";
        });
