            ...
            for($i =1; $i <= $count; $i++){
                ...
                echo "
                    <article class='cont'>
                        ...
                        <h4 class='QnA__title'><a href='http://hjkang306.dothome.co.kr/php/Notice/QnACate.php?category=".$myPageQustionInfo['QnACategory']."'>".$myPageQustionInfo['QnATitle']."</a></h4>
                        <div class='myPageQuestion__btn'>
                            <a class='myPageQuestion__modify__btn' href='http://hjkang306.dothome.co.kr/php/Notice/QnAModify.php?QnAID=".$myPageQustionInfo['myQnAID']."'>수정</a>
                            <a class='myPageQuestion__delete__btn ".$myPageQustionInfo['myQnAID']."'>삭제</a>
                        </div>
                        <div class='icon'>
                            <a href='#' class='AnserNum'>".$myPageQustionInfo['QnAReply']."</span></a>
        ...
        deleteBtns.forEach(deleteBtn => {
            ...
            e.preventDefault();
                if(!confirm("정말 삭제하시겠습니까?")) {
                    ...
                    location.href = `http://hjkang306.dothome.co.kr/php/Notice/QnADelete.php?QnAID=${className}`;
                }
            });
        })
    </script>
