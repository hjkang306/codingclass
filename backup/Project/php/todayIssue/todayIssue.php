...
<body>
    <?php
        ...
        $candidate = array();
        $targetDate = '2022-10-17';

        $dateSql = "SELECT myTipsID, regTime FROM myTips ORDER BY regTime";
        $dateResult = $connect -> query($dateSql);
        foreach($dateResult as $date) {
            echo "1 : ".date('Y-m-d', $date['regTime'])."<br> ";
            echo "2 : ".$targetDate."<br> ";
            
            if((string)date('Y-m-d', $date['regTime']) == $targetDatearget) {
                echo "같음";
            }
        }
    ?>
            ...
            <div class="slider__img">
                <div class="slider__inner">
                    <div class="slider">
                        ...
                        <img src="../../html/asset/img/slider01.jpg" alt="01">
                        <div class="text">
                            <span class="cate">
                                취미 > 등산
                            </span>
                    ...
                    <div class="slider">
                        ...
                        <img src="../../html/asset/img/slider02.jpg" alt="02">
                        <div class="text">
                            <span class="cate">
                                취미 > 등산
                            </span>
                    ...
                    <div class="slider">
                        ...
                        <img src="../../html/asset/img/slider03.jpg" alt="03">
                        <div class="text">
                            <span class="cate">
                                취미 > 등산
                            </span>
                    ...
                    <div class="slider">
                        ...
                        <img src="../../html/asset/img/slider04.jpg" alt="04">
                        <div class="text">
                            <span class="cate">
                                취미 > 등산
                            </span>
                    ...
                    <div class="slider">
                        ...
                        <img src="../../html/asset/img/slider05.jpg" alt="05">
                        <div class="text">
                            <span class="cate">
                                취미 > 등산
                            </span>
