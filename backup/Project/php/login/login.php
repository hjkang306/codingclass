<div id="login__wrap">
    <section id="login__box">
        <div class="login__inner LoginMain">
            <h2>로그인</h2>
            <form name="login" action="http://hjkang306.dothome.co.kr/php/login/loginSave.php" method="post">
                <fieldset>
            ...
            <div class="login__service">
                <a href="http://hjkang306.dothome.co.kr/php/login/joinAgree.php" class="join btn3">회원가입</a>
        ...
        <div class="login__inner AuthEmailResult">
            <h2>이메일 인증완료</h2>
            <form action="http://hjkang306.dothome.co.kr/php/login/join.php" method="post">
                <fieldset>
...
<script>
    ...
    pwChangeResultHomeBtn.addEventListener('click', () => {
        location.href = "http://hjkang306.dothome.co.kr/php/main/category_R.php";
    });
...
<script>
    ...
    function PWChange() {
        ...
        $.ajax({
            type : "POST",
            url  : "http://hjkang306.dothome.co.kr/php/login/PWChange.php",
    ...
    function IDPhoneChecking() {
        ...
        $.ajax({
            type : "POST",
            url  : "http://hjkang306.dothome.co.kr/php/login/IDFind.php",
    ...
    function pwEmailChecking() {
        ...
        $.ajax({
            type : "POST",
            url  : "http://hjkang306.dothome.co.kr/php/login/passwordFind.php",
