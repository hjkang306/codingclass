    ...
    if($result){
        ...
        if($count > 0){
            for($i=1; $i <= $count; $i++){
                ...
                echo "<li><a href='http://hjkang306.dothome.co.kr/php/category/small_cg_detail.php?categoryBig={$info['TipsCateBig']}&categorySmall={$info['TipsCateSmall']}&myTipsID={$info['myTipsID']}'>".$info['TipsTitle']."</a></li>";
            ...
            echo "<a class='goQNABtn' href='http://hjkang306.dothome.co.kr/php/Notice/QnACate.php'>QnA 게시판으로 이동하기</a>";
        }
    }
    ?>
                        </ul>
                        ...
                        <a class="goQNABtn" href="http://hjkang306.dothome.co.kr/php/Notice/QnACate.php">QnA 게시판으로 이동하기</a> -->
                    </div>
                    <div class="jobsbeeIcon searchYes"></div>
                </div>
                <div class="more"><a href="http://hjkang306.dothome.co.kr/php/category/category_R.php">더 알아보기</a></div>
            </div>
        </section>
        <!-- //jobsbeenator -->
    </main>
