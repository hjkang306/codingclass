        ...
        <section id="category" class="container">
            ...
            <div class="category__inner">
                <div class="categoryIcon">
                    <a href="http://hjkang306.dothome.co.kr/php/category/category_S.php?categoryBig=건강">
                        <div class="icon icon1"></div>
                        <h4>건강</h4>
                    </a>
                </div>
                <div class="categoryIcon">
                <a href="http://hjkang306.dothome.co.kr/php/category/category_S.php?categoryBig=전자기기">
                        <div class="icon icon2"></div>
                        <h4>전자기기</h4>
                    </a>
                </div>
                <div class="categoryIcon">
                    <a href="http://hjkang306.dothome.co.kr/php/category/category_S.php?categoryBig=청소">
                        <div class="icon icon3"></div>
                        <h4>청소</h4>
                    </a>
                </div>
                <div class="categoryIcon">
                    <a href="http://hjkang306.dothome.co.kr/php/category/category_S.php?categoryBig=취미">
                        <div class="icon icon4"></div>
                        <h4>취미</h4>
                    </a>
                </div>
                <div class="categoryIcon">
                    <a href="http://hjkang306.dothome.co.kr/php/category/category_S.php?categoryBig=라이프스타일">
...
<?php
    // 두개의 테이블 join
    $sql = "SELECT b.myTipsID, b.TipsTitle, b.TipsView, b.TipsLike, b.TipsCateBig, b.TipsCateSmall, b.regTime FROM myTips b JOIN myMember m ON (b.myMemberID = m.myMemberID) ORDER BY TipsLike DESC LIMIT 0, 3";
    ...
    if($result){
        ...
        if($count > 0){
            for($i=1; $i<=3; $i++){
                ...
                switch ($i) {
                    case 1 :
                        echo "<li class='gold'><a href='http://hjkang306.dothome.co.kr/php/category/small_cg_detail.php?categoryBig={$info['TipsCateBig']}&categorySmall={$info['TipsCateSmall']}&myTipsID={$info['myTipsID']}'><h4>".$info['TipsTitle']."</h4></a></li>";
                    break;
                    case 2 :
                        echo "<li class='silver'><a href='http://hjkang306.dothome.co.kr/php/category/small_cg_detail.php?categoryBig={$info['TipsCateBig']}&categorySmall={$info['TipsCateSmall']}&myTipsID={$info['myTipsID']}'><h4>".$info['TipsTitle']."</h4></a></li>";
                    break;
                    case 3 :
                        echo "<li class='bronze'><a href='http://hjkang306.dothome.co.kr/php/category/small_cg_detail.php?categoryBig={$info['TipsCateBig']}&categorySmall={$info['TipsCateSmall']}&myTipsID={$info['myTipsID']}'><h4>".$info['TipsTitle']."</h4></a></li>";
                    break;
                    // http://hjkang306.dothome.co.kr/php/category/small_cg_detail.php?myTipsID=7
                }
            }
        } 
        else {
