...
<script>
    location.href = "http://bb020440.dothome.co.kr/php/category/small_cg_detail.php?categoryBig=<?php echo $boardCateBig;?>&categorySmall=<?php echo $boardCateSamll;?>&myTipsID=<?php echo $TipsID['myTipsID']?>";
</script>