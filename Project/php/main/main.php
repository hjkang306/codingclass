    ...
    if($result){
        ...
        if($count > 0){
            for($i=1; $i<=3; $i++){
                ...
                switch ($i) {
                    case 1 :
                        echo "<li class='gold'><a href='http://bb020440.dothome.co.kr/php/category/small_cg_detail.php?categoryBig={$info['TipsCateBig']}&categorySmall={$info['TipsCateSmall']}&myTipsID={$info['myTipsID']}'><h4>".$info['TipsTitle']."</h4></a></li>";
                    break;
                    case 2 :
                        echo "<li class='silver'><a href='http://bb020440.dothome.co.kr/php/category/small_cg_detail.php?categoryBig={$info['TipsCateBig']}&categorySmall={$info['TipsCateSmall']}&myTipsID={$info['myTipsID']}'><h4>".$info['TipsTitle']."</h4></a></li>";
                    break;
                    case 3 :
                        echo "<li class='bronze'><a href='http://bb020440.dothome.co.kr/php/category/small_cg_detail.php?categoryBig={$info['TipsCateBig']}&categorySmall={$info['TipsCateSmall']}&myTipsID={$info['myTipsID']}'><h4>".$info['TipsTitle']."</h4></a></li>";
                    break;
